...
import 'package:movie/movies_module/presentation/controller/movie_details_bloc.dart';
...
class MoviesBloc extends Bloc<MoviesEvent, MoviesState> {
  ...
  MoviesBloc(this.getNowPlayingMoviesUseCase, this.getPopularMoviesUseCase,
    ...
    on<GetTopRateMoviesEvent>(_getTopRatedMovies);
  ...
  FutureOr<void> _getTopRatedMovies(
      GetTopRateMoviesEvent event, Emitter<MoviesState> emit) async {
